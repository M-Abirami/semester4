...
const Profile2 = props => {
  ...
  return (
    ...
    <div style={{alignItems:"center",backgroundColor:'white',marginLeft:170,marginRight:170,width:1000,height:1150,borderRadius:20,marginBlockStart:100}}> 
        ...
        <p>
        <strong style={{marginLeft:140}}>Name:Ajitha</strong>
        {profileState.Name}
      </p>
      <p>
      ...
      <p>
        <strong style={{marginLeft:140}}>HolderName:     S.Ajitha</strong>
      ...
      <p>
        <strong style={{marginLeft:140}}>Branch:      thirupur</strong>
        {profileState.branch}
      </p>
      <p>
