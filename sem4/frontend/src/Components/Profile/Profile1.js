...
const Profile1 = props => {
  ...
  return (
    ...
    <div style={{alignItems:"center",backgroundColor:'white',marginLeft:170,marginRight:170,width:1000,height:1150,borderRadius:20,marginBlockStart:100}}> 
        ...
        <p>
        <strong style={{marginLeft:140}}>Name:Dhanushya</strong>
        {profileState.Name}
      </p>
      <p>
      ...
      <p>
        <strong style={{marginLeft:140}}>dateofEntrollment:    15.07.2021</strong>
        {profileState.dateofEntrollment}
      </p>
      <p>
        <strong style={{marginLeft:140}}>EntrollingOfficer:    M.Deeva</strong>
        {profileState.entrollingOfficer}
      </p>
      <p>
        <strong style={{marginLeft:140}}>RegimentNo:   2</strong>
        {profileState.regimentNo}
      </p>
      <p>
        <strong style={{marginLeft:140}}>Rank:   2</strong>
        {profileState.rank}
      </p>
      <p>
        <strong style={{marginLeft:140}}>Incharge:   balaji</strong>
      ...
      <p>
        <strong style={{marginLeft:140}}>Dob:     06.04.1999</strong>
        {profileState.dob}
      </p>
      <p>
      ...
      <p>
        <strong style={{marginLeft:140}}>HolderName:     S.Dhanushya</strong>
      ...
      <p>
        <strong style={{marginLeft:140}}>Branch:      somanur</strong>
        {profileState.branch}
      </p>
      <p>
